...
\** LGPL allows dynamic linking without copyleft. Python imports are generally considered dynamic linking.
\*** MPL 2.0 is file-level copyleft — only modified MPL files need to stay MPL.
